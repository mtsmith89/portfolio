...
const SocialIcons = (props, context) => {
  ...
  return (
    <div className="social-icons animate-icons">
        <a target="_blank" rel="noopener noreferrer" href="https://github.com/mtsmith89" style={ { color: colorPrimary } }><i className="fab fa-github"></i></a>
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://stackoverflow.com/story/mtsmith89" style={ { color: colorPrimary } }><i className="fab fa-stack-overflow"></i></a>
        <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/michael-travis-smith-848920a1" style={ { color: colorPrimary } }><i className="fab fa-linkedin"></i></a>
